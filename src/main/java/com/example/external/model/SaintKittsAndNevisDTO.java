...
public class SaintKittsAndNevisDTO implements Serializable {
	...
	private int deathRatio;

	@SerializedName("recovery_ratio")
	private int recoveryRatio;
	...
	public void setDeathRatio(int deathRatio){
		this.deathRatio = deathRatio;
	}

	public int getDeathRatio(){
		return deathRatio;
	}
